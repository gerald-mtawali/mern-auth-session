...
function Signup() {
    ...
    // this function is required for updating the input field
    ...
    // handle the toggling of showing and not showing the password to the user
    ...
    /* Stack Component: a MUI component that acts like a form, also includes a onSubmit prop, 
                which points to our custom made handleSubmit function 
                    ...
                    <Stack
                        ...
                        <FormControl variant='filled'>
                            ...
                            <FormHelperText error={errors.password}> 
                                Password must be at least 8 characters, have 1 symbol, 1 uppercase letter, 
                                1 lowercase letter, and 1 digit
                            </FormHelperText>
                        </FormControl>
                        {/* Repeat password field */}
                        <FormControl variant='filled'>
                            <InputLabel htmlFor='password-repeat-field'>Password</InputLabel>
                            <FilledInput 
                        ...
                        {errors.fetchError && (<FormHelperText error> {errors.fetchErrorMsg}</FormHelperText>)}
                        <Divider />
